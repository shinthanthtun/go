...
func main() {
	...
	for remainingTicket > 0 && len(bookings) < 50 {
		...
		if isValidName && isValidEmail && isValidTickets {
			BookTickets(remainingTicket, userTickets, bookings, firstName, lastName, email)
...
func BookTickets(remainingTicket uint, userTickets uint, bookings []string, firstName string, lastName string, email string) {
